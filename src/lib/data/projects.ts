...
export const projects: Project[] = [
  {
    ...
    shortDescription:
      "Add social media icons to `ggplot2` charts with ease using Font Awesome 7.",
    imageUrl:
  ...
  },
  {
    ...
    shortDescription:
      "Shiny app for fair and transparent household expense splitting.",
    ...
    tags: ["R", "Shiny", "data analysis", "app"],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    tags: ["R", "data viz", "humanitarian", "package"],
    badge: "ongoing",
  },
  {
    id: 8,
    ...
    shortDescription:
      "Comprehensive R package for humanitarian indicators and MSNA analysis.",
    imageUrl:
