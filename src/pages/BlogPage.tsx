...
export default function BlogPage(): JSX.Element {
  ...
  return (
    <>
      <Helmet>
        <title>Blog | No Sights by Guillaume Noblet</title>
        <meta
          name='description'
          content="Read my blog about anything and nothing. There is nothing out there for now."
        />
        <link
          rel='canonical'
          href='https://gnoblet.github.io/blog'
        />
      </Helmet>
