  ...
  return (
    ...
    >
      <div className='flex h-3/4 flex-col justify-center space-y-4 sm:space-y-6'>
        ...
        >
          I specialize in <HighlightText> research in humanitarian settings </HighlightText> and{' '}
          <HighlightText>data visualization</HighlightText>.
        </h1>
        <p
          className={clsx(
        ...
        >
          Former Research & Data Manager at <InlineLink href='https://impact-initiatives.org'>IMPACT Initiatives</InlineLink>
        </p>
